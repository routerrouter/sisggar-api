...
public class CompanyController {
    ...
    @Operation(summary = "Registar Empresa", method = "POST", tags = {"company" })
    @ApiResponses(value = {
    ...
    @Operation(summary = "Actuaizar Logotipo/imagem", method = "PATCH", tags = {"company" })
    @ApiResponses(value = {
    ...
    @Operation(summary = "Detalhes da Empresa", method = "GET", tags = {"company" })
    @ApiResponses(value = {
